...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://vendorsweetapplication_user:xcyO5P1KInHQApzRgQ0TCzcGbQKdZuC8@dpg-cohpi0ol5elc73cruit0-a.oregon-postgres.render.com/vendorsweetapplication"
